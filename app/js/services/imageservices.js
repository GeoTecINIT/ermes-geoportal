...
(function() {
  ...
  define([
    "esri/layers/ArcGISImageServiceLayer", "esri/layers/ImageServiceParameters", "esri/layers/MosaicRule", "dojo/_base/array", "dojo/_base/json", 
    ...
    function _loadServices(config) {
      ...
      var ndviLayerURL = "http://ermes.dlsi.uji.es:6080/arcgis/rest/services/Prototype/Italy_NDVI_2014a/ImageServer";
      //var ndviLayerURL = "http://sampleserver3.arcgisonline.com/ArcGIS/rest/services/World/Temperature/ImageServer";
      ...
      mr.lockRasterIds = [1];   // Only accesss to raster id 5
